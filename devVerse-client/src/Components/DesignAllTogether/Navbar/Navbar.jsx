...
import NotificationBtn from "../../Masud/Notification/NotificationBtn";
  ...
  return (
    <>
          ...
          <div className="flex justify-between items-center">
            ...
            {user ? (
              <div className="flex justify-between items-center">
                ...
                <Link
                  className="dark:hover:bg-gray-700 dark:hover:bg-opacity-30 hover:bg-gray-100 sm:px-3 px-2 py-2 sm:rounded-2xl rounded-full duration-200"
                  to={`/chat/${user?.email}`}
                >
                ...
                >
                  {add}{" "}
                  <span className="sm:block text-sm hidden text-nowrap">
                    Add Post
                  </span>
                </Link>
      ...
      <span
        ...
        } w-full h-screen lg:hidden bg-black bg-opacity-20 lg:py-8 py-5 shadow-2xl fixed top-0 right-0 rounded-lg z-10`}
      ></span>
