...
const Message = () => {
  ...
  const canUseDropdown =
    users2 &&
    (users2.users?.mainuser?.role !== "member" ||
      users2?.users?.mainuser?.userType !== "normal");
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-2xl max-w-md w-full">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">
              Access restricted. Unlock premium features or contact the admin
              for more details.
            </p>
          </div>
        </div>
