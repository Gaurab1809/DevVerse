...
const GetPremium = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-white to-gray-100 dark:from-gray-900 dark:to-gray-800 py-16">
      <Helmet>
        <title>DevVerse | Get Premium</title>
      </Helmet>
      <style>{`
  @keyframes glow {
    0% {
...
`}</style>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-6 md:px-12 lg:px-24">
        <div className="space-y-6">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            Unlock a world of premium content and features with{" "}
            <strong>DevVerse Premium</strong>. Get exclusive access to mentors,
            real-time support, and live screen-sharing sessions.
          </p>
          ...
          <div className="flex flex-col md:flex-row space-x-0 md:space-x-4 mt-8">
            <Link className="w-full md:w-2/3 mt-2 md:mt-0">
              <button
                onClick={() => openModal(3999)}
                className="flex items-center space-x-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white font-semibold px-6 py-3 rounded-lg glow-button transition duration-300 w-full"
              >
      ...
      <div className=" mt-32 mx-auto px-4">
        <h1 className="text-center text-3xl font-semibold mb-14 text-blue-600 dark:text-blue-400">
          Embrace Professional Life with DevVerse
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {[
            ...
            },
            {
              ...
              description:
                "Join real-time meetings to learn and grow directly with industry experts.",
            },
            {
              title: "Screen Share",
              img: "https://res.cloudinary.com/dpomtzref/image/upload/v1729361121/7800160_3745856_n2xnty.jpg",
              description:
                "Share your screen to get hands-on help and solve problems quickly.",
            },
            {
              title: "Chat Support",
              img: "https://res.cloudinary.com/dpomtzref/image/upload/v1729361284/5569546_2880024_nsxhep.jpg",
              description:
                "Message our mentors and receive expert guidance within 6 hours.",
            },
          ].map((feature, index) => (
            <div
              key={index}
      ...
      <p className="text-center   md:w-1/2 mt-10 flex  justify-center mx-auto text-xs">
        Subscriptions automatically renew <br />* Custom app icons are only
        available through a paid DevVerse Premium subscription.
      </p>
