...
import Switcher1 from "../../../Components/DesignAllTogether/Switcher1/Switcher1";
import Logo from "../../../Components/DesignAllTogether/Logo/Logo";
...
const UserProfile = () => {
  ...
  return (
    <section className="min-h-screen flex bg-gray-100 dark:bg-gray-900">
      <Helmet>
        <title>DevVerse | UserProfile</title>
      </Helmet>
      ...
      <div className="lg:hidden fixed top-0 left-0 w-full flex justify-between items-center bg-gray-100 dark:bg-gray-900 p-4 shadow-md z-30">
        <Link to="/" className="flex items-center">
          <img
            ...
            className="h-8"
          />
          <h1 className="text-3xl text-gray-900 dark:text-gray-100">evVerse</h1>
        </Link>
      ...
      {isActive && (
        <div
          className="fixed inset-0 z-20 lg:hidden bg-black opacity-50"
          onClick={handleToggle}
        ></div>
      )}
    </section>
