...
import PostComponent from "../../Gaurab/Card/PostComponent";
import SkeletonLoader from "../../Gaurab/Card/SkeletonLoader";
import DropDown from "../../Gaurab/Card/DropDown";
import PostActions from "../../Gaurab/Card/PostActions";
import Chatbot from "../../Gaurab/Cahtbot/Chatbot";
import useAxiosPublic from "../../Hooks/useAxiosPublic";
import InfiniteScroll from "react-infinite-scroll-component";
import RecentPostCard from "../../Components/DesignAllTogether/RecentPostCard/RecentPostCard";
import Slider from "../../Components/DesignAllTogether/Slider/Slider";
import ShareButton from "../../Gaurab/Card/ShareButton";
...
const Following = () => {
  ...
  const fetchFollowingPosts = async () => {
    try {
      const res = await axiosPublic.get(
        `/get-following-posts/${user?.email}?page=${page2}&limit=5`
      );
  ...
  return (
    <div className="mx-auto max-w-[1090px] pb-10 w-[95%]">
      <Helmet>
        <title>DevVerse | Following</title>
      </Helmet>
      <div className="mt-3">
        <Slider />
      </div>
      <div className="flex justify-between lg:mx-auto mt-5">
        ...
        <div
          id="scrollableDiv"
          className="sticky top-[68px] scrollBar h-[calc(100vh-80px)] overflow-y-auto lg:w-[28%] w-[32%] border dark:border-gray-800 rounded-xl py-5 px-3 lg:block hidden"
        >
          <h2 className="font-semibold text-black dark:text-white mb-5 px-3">
            Recent Posts
          </h2>
