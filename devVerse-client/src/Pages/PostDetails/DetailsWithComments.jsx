...
import Comment from "../../Components/Masud/Comment/Comment";
import PostComponent from "../../Gaurab/Card/PostComponent";
import { Helmet } from "react-helmet";
import PollData from "../../Gaurab/Card/PollData";
...
const DetailsWithComments = () => {
  ...
  useEffect(() => {
    axiosPublic.get(`/get-post-details/${id}`).then((result) => {
      setData(result.data);
    });
  }, [id]);
  ...
  return (
    <section className="my-4 pb-4">
      <Helmet>
        <title>DevVerse | Post Details</title>
      </Helmet>
      {data && (
        <div className="mx-auto px-2 md:px-20 lg:px-32">
          ...
          <div id="commentSection">
            <button
              ...
              className="flex items-center gap-2 rounded-full p-2 border-2 bg-slate-100 dark:bg-gray-700 dark:border-gray-700 font-medium"
            >
              <IoMdAdd /> Add a Comment
            </button>
          </div>
          <div>
            {showCommentBox && (
