      ...
      <div className="container relative mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="space-y-2">
              <FooterLink to="/get-premium" text="DevVerse Premium" />
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="space-y-2">
              <FooterLink to="/" text="devVerse.com" />
              <FooterLink to="/" text="devVerse for Community" />
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="space-y-2">
              ...
              <FooterLink to="/" text="devVersesafety" />
        ...
        <div className="border-t border-gray-300 dark:border-gray-700 pt-6 text-center text-sm">
          <p className="text-gray-600 dark:text-gray-400">
            &copy; {new Date().getFullYear()} DevVerse, Inc. All rights
            reserved.
          </p>
          <p className="mt-2">
