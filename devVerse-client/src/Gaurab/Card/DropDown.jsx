...
import {
  handleArchive,
  handleReport,
} from "../../Components/Masud/HandleArchive&Report";
import { useContext } from "react";
import { AuthContext } from "../../Providers/AuthProvider";
import useCheckArchiveStatus from "../../Hooks/AKM/useCheckArchiveStatus";
import useCheckReportStatus from "../../Hooks/AKM/useCheckReportStatus";
...
const DropDown = ({ id, isOpen, toggleDropdown, archiveData }) => {
  ...
  const { reported, refetch: refetchReport } = useCheckReportStatus(
    archiveData?._id,
    user?.email
  );
